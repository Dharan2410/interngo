...
//   empId: res?.empId || "",
//   companyEmail: res?.empEmail || "",
//   designation: res?.designation || "",
//   batch: res?.batch || "",
//   year: res?.year || "",
//   phase: res?.phase || "",
//   joiningDate: res?.dateofjoining || "",
//   status: res?.activeStatus ? "Active" : "Inactive",
// });
...
//                 .filter(
//                   (t) =>
//                     !(t === "Experience" && (role === "intern" || role === "admin")) &&
...
//                   <button
//                     onClick={async () => {
//                       const res = await fetch(`http://localhost:4000/interngo/profile/${userId}`, {
//                           method: "PUT",
            ...
            <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-[20000]">
              ...
              >
                ...
                <div className="flex justify-end gap-4 mt-8">
                  ...
                  <button
                    onClick={async () => {
                      const res = await fetch(`http://localhost:4000/interngo/editprofile/${userId}`, {
                          method: "PUT",
                          headers: { "Content-Type": "application/json" },
                          body: JSON.stringify({
                            ...professionalInformation,
